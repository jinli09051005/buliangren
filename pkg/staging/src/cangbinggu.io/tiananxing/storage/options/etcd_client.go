...
func (o *ETCDClientOptions) ApplyFlags() []error {
	...
	fmt.Printf("8888888888888888888888888888:%s", configETCDServers)
	fmt.Printf("8888888888888888888888888888:%s", configETCDCAFile)
...
func (o *ETCDClientOptions) NewClient() (*clientv3.Client, error) {
	...
	fmt.Printf("mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm:%v", tlsConfig)
	if err != nil {
		fmt.Printf("uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu:%v", err)
		return nil, err
	}
...
func (o *ETCDClientOptions) NewHealthCheck() (func() error, error) {
	...
	go func() {
		if err := wait.PollUntil(time.Second, func() (bool, error) {
			...
			fmt.Errorf("Failed to wait poll until", err)
		}
	}()
